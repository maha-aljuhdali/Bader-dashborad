import 'package:bader_dashboard/model/admin_model.dart';
...
class AuthRepository {
  ...
  Future<bool> forgetPassword({required String email}) async {
    try {
      ...
      debugPrint(
          "Failed To send Password Reset to Email, reason : ${e.toString()}");
      return false;
    }
  }
  ...
  Future<void> updateAdminPassword(
      {required String newPassword, required String adminID}) async {
    await FirebaseFirestore.instance
        .collection('Admin')
        .doc(adminID)
