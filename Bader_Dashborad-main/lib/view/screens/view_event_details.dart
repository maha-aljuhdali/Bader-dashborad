  ...
  return ListView(
    ...
    children: [
      ...
      Center(
        ...
        style: TextStyle(
            color: Colors.grey, fontWeight: FontWeight.w500, fontSize: 14.sp),
      )),
      SizedBox(
        height: 12.5.h,
      ),
      Text(
        "النادي",
        style: TextStyle(
            fontWeight: FontWeight.bold, fontSize: isMobile ? 15.5.sp : 18.sp),
      ),
      SizedBox(
        height: 2.5.h,
      ),
      _containerItem(isMobile: isMobile, text: model.clubName!),
      SizedBox(
        height: 2.5.h,
      ),
      Text(
      ...
      _containerItem(
          isMobile: isMobile,
          text: model.forPublic == EventForPublicOrNot.public.name
              ? " عامة للجميع"
              : "خاصة بأعضاء النادي فقط"),
      SizedBox(
        height: 2.5.h,
      ),
      Text(
      ...
      _containerItem(isMobile: isMobile, text: model.location!),
      SizedBox(
        height: 2.5.h,
      ),
      Text(
      ...
      _containerItem(isMobile: isMobile, text: model.link!),
      SizedBox(
        height: 2.5.h,
      ),
      Text(
      ...
      _containerItem(isMobile: isMobile, text: model.startDate!),
      SizedBox(
        height: 2.5.h,
      ),
      Text(
      ...
      _containerItem(isMobile: isMobile, text: model.endDate!),
      SizedBox(
        height: 2.5.h,
      ),
      Text(
      ...
      _containerItem(isMobile: isMobile, text: model.time!),
    ],
  );
}
