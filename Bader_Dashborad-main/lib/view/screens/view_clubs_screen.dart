...
import 'package:bader_dashboard/view/screens/view_club_details.dart';
...
Widget _clubItem(
    ...
    required ClubModel model,
    required BuildContext context,
    required DashBoardCubit cubit,
    required int index}) {
  return Container(
    padding: EdgeInsets.symmetric(
        horizontal: isMobile ? 12.w : 8.w, vertical: isMobile ? 7.h : 15.h),
      ...
      trailing: MaterialButton(
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      ViewClubDetails(model: cubit.clubs[index])));
        },
