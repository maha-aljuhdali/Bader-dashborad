import 'package:bader_dashboard/model/user_model.dart';
...
class AssignClubLeaderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cubit = DashBoardCubit.getInstance(context)
      ..getUsersThatAreNotLeaders()
      ..getClubsWithoutLeader();
            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton(
                      ...
                      items: cubit.clubsWithoutLeaderData
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton(
                      ...
                      onChanged: (emailChosen) {
                        cubit.chooseALeaderFromDropDownButton(
                            value: emailChosen!);
                      },
                      items: cubit.usersThatAreNotLeadersData
                          .map((e) => DropdownMenuItem(
                                value: e.email,
                                child: Text(
                                  e.email!,
                ...
                MaterialButton(
                    ...
                    onPressed: () async {
                      if (cubit.selectedClubName == null ||
                          cubit.selectedLeaderEmail == null) {
                        showSnackBar(
                            context: context,
                            message: "الرجاء ادخال البيانات كاملة",
                            backgroundColor: Colors.red);
                      } else {
                        UserModel leader = await cubit
                            .getInfoForSelectedLeaderFromDropDownButton(
                                email: cubit.selectedLeaderEmail!);
                        ClubModel club =
