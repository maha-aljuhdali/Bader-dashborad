  ...
  return ListView(
    ...
    children: [
      model.image != null
          ...
          : Container(
              padding: EdgeInsets.symmetric(
                  vertical: isMobile ? 5.h : 10.h,
                  horizontal: isMobile ? 5.w : 10.w),
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.image,
                      color: Colors.green, size: isMobile ? 20.sp : 30.sp),
                  SizedBox(
                    width: isMobile ? 5.w : 2.w,
                  ),
                  FittedBox(
                      fit: BoxFit.scaleDown,
                      child: Text(
                        "لم يتم إضافة شعار للنادي",
                        style: TextStyle(
      ...
      _containerItem(isMobile: isMobile, text: model.college!),
      SizedBox(
        height: 2.5.h,
      ),
      Text(
      ...
      if (model.contactAccounts != null)
        Column(
          ...
          children: [
            ...
            _containerItem(
                isMobile: isMobile, text: model.contactAccounts!.email!),
            SizedBox(
              height: 2.5.h,
            ),
            Text(
            ...
            _containerItem(
                isMobile: isMobile, text: model.contactAccounts!.twitter!),
          ],
        ),
    ],
  );
