          ...
          child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return _categoryItem(
                    ...
                    isMobile: isMobile,
                    routeName:
                        cubit.adminCategories[index].routeName.toString(),
          ...
          FittedBox(
              ...
              child: Text(
                ...
                style: TextStyle(
                    ...
                    fontSize: isMobile ? 16.5.sp : 18.sp),
              ))
        ],
      ),
    ),
